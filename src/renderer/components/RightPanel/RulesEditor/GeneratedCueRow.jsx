...
export default function GeneratedCueRow({ cue, ruleSetId, onUpdate, onRemove }) {
  ...
  return (
    <div style={{ padding: '7px 10px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.055)', borderRadius: 7 }}>
      {/* Row 1: type, slot, bar offset, label, delete */}
